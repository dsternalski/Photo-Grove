...
var $author$project$PhotoGallery$initalModel = {activity: '', chosenSize: $author$project$PhotoGallery$Medium, hue: 0, noise: 0, ripple: 0, status: $author$project$PhotoGallery$Loading};
...
var $author$project$PhotoGallery$init = function (flags) {
	...
	return _Utils_Tuple2(
		_Utils_update(
			$author$project$PhotoGallery$initalModel,
			{activity: activity}),
