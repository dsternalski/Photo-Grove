...
var $author$project$PhotoGroove$initalModel = {chosenSize: $author$project$PhotoGroove$Medium, hue: 5, noise: 5, ripple: 5, status: $author$project$PhotoGroove$Loading};
...
var $author$project$PhotoGroove$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2($author$project$PhotoGroove$initalModel, $author$project$PhotoGroove$initialCmd);
		},
