...
var $author$project$PhotoGroove$initalModel = {
...
var $author$project$PhotoGroove$photoArray = $elm$core$Array$fromList($author$project$PhotoGroove$initalModel.photos);
...
var $author$project$PhotoGroove$main = $elm$browser$Browser$element(
	{
		init: function (flags) {
			return _Utils_Tuple2($author$project$PhotoGroove$initalModel, $elm$core$Platform$Cmd$none);
		},
